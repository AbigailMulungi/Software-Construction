...
# Defining base class for all employees
class Employee(ABC):
...
# Defining separate classes for Manager and Developer
...
# Defining separate classes for report generation
...
# Defining separate class for bonus calculation
